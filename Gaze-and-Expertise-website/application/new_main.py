...
quotes = ['"Standing on the shoulders of giants" - Newton'] #, '"The saddest summary of a life contains three descriptions: could have, might have, and should have." - Louis E. Boone']
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setStyleSheet("background: url(:/background.jpg)")
...
"    border-radius:5px;\n"
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Capture eye-gaze"))
        self.quotes.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-style:italic;\">&quot;Standing on the shoulders of giants&quot; - Newton</span></p></body></html>"))
        self.analyseCommandLink.setText(_translate("MainWindow", "    Store results after experiment completion"))
        self.title.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:28pt;\">Capture Eye-gaze</span></p></body></html>"))
        self.summariseButton.setText(_translate("MainWindow", "Start"))
        self.lengthCombo.setItemText(0, _translate("MainWindow", "Start Recording..."))
