...
class recordThread(QtCore.QThread):
    ...
    def run(self):
        rThread = subprocess.Popen(
            ["python3", "../text_extraction/Frame_recording.py"])
...
class gazeThread(QtCore.QThread):
    ...
    def run(self):
        ...
        eyeGaze = subprocess.Popen(
            ["python3", "../GazeTracking/example.py"], stdout=subprocess.PIPE)
...
class Ui_Dialog_time_elapsed(Qt.QMainWindow, object):
    def setupUi(self, Dialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/images/I5nk-Pen-icon.png"),
        ...
        self.frame.setStyleSheet(
            "background-image: url(:/images/transparent-photoshop-background-grid-260nw-1023662581.jpg);")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/images/images.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate(
            "Dialog", "<html><head/><body><p align=\"center\"><span style=\" font-size:14pt;\">Not Recording</span></p></body></html>"))
    ...
    def recording(self):
        ...
        _translate = QtCore.QCoreApplication.translate
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/images/images_stop.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolButton.setIcon(icon1)
        self.toolButton.clicked.disconnect()
        self.label.setText(_translate(
            "Dialog", "<html><head/><body><p align=\"center\"><span style=\" font-size:12pt; color:#ff0000;\">Recording......</span></p></body></html>"))
